...
Netflix lets you download all your data - every show you have watched, every dollar you have spent. But the files are just raw CSVs. This program makes them readable.

You pick a profile (or all of them), then choose from a menu:

1. **Total Spent** - how much you have paid since joining. Asks if you want PYG conversion too.
...
It automatically skips trailers, hooks, and autoplay previews so your real watch time is not inflated.
...
4. You will get a folder with a name like `1343059170`
...
## Files
   ...
   requirements.txt - the libraries needed: pandas and requests.
